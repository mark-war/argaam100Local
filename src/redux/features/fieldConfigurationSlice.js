...
export const fetchScreenerTabData = createAsyncThunk(
  "screener/fetchScreenerTabData",
...
const fieldConfigurationSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // Screener Tab Data
      .addCase(fetchScreenerTabData.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(fetchScreenerTabData.fulfilled, (state, action) => {
        state.loading = false;
      ...
      .addCase(fetchScreenerTabData.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      });
  },
